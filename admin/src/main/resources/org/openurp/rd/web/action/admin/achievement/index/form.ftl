...
<div style="margin:0px 20px">
  ...
  [@b.form action=sa theme="list"]
    ...
    [@b.textfield name="rdAchievement.organization" label="完成单位" value=rdAchievement.organization! required="true" maxlength="300"/]
    [@b.textfield name="rdAchievement.website" label="成果网址" value=rdAchievement.website! required="false" maxlength="300"/]
    [@b.formfoot]
  ...
  [#if rdAchievement.persisted]
   ...
   <div class="card card-info card-primary card-outline">
      ...
      [@b.div href="award!search?rdAchievementAward.achievement.id=${rdAchievement.id}"/]
   </div>
  [/#if]
</div>
[@b.foot/]
