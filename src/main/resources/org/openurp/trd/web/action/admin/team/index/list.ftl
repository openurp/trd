...
[@b.grid items=teachingTeams var="teachingTeam"]
  [@b.gridbar]
    ...
    bar.addItem("${b.text("action.export")}",action.exportData("code:编号,name:项目名称,leaderNames:负责人,department.name:所在院系,level.name:级别,beginOn:立项年月,memberNames:团队成员,awardTitle:获奖名称,remark:备注",null,'fileName=团队信息'));
  [/@]
  [@b.row]
    [@b.boxcol /]
