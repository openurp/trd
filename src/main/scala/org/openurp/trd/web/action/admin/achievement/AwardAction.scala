...
import org.openurp.trd.web.helper.RdAchievementAwardImportListener

import java.io.{ByteArrayInputStream, ByteArrayOutputStream}

class AwardAction extends RestfulAction[RdAchievementAward], ExportSupport[RdAchievementAward], ImportSupport[RdAchievementAward] {
  ...
  def downloadTemplate(): Any = {
    ...
    schema.generate(os)
    Stream(new ByteArrayInputStream(os.toByteArray), MediaTypes.ApplicationXlsx, s"教学成果获奖模板.xlsx")
  }
}
