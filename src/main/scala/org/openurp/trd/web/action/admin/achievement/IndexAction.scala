...
import org.openurp.trd.achievement.model.RdAchievement
import org.openurp.trd.web.helper.RdAchievementImportListener

import java.io.{ByteArrayInputStream, ByteArrayOutputStream}

class IndexAction extends RestfulAction[RdAchievement], ExportSupport[RdAchievement], ImportSupport[RdAchievement] {
  ...
  def downloadTemplate(): Any = {
    ...
    schema.generate(os)
    Stream(new ByteArrayInputStream(os.toByteArray),MediaTypes.ApplicationXlsx, s"教学成果模板.xlsx")
  }
}
